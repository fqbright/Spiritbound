...
const EQUIPMENT = [
	...
	{"id":"tideCharm","slot":"charm","icon":"≋","icon_kind":"pendant","icon_flourish":"wave","zh":"灵潮玉佩","en":"Tide Charm","detail":"第 2 回合额外抽 1 张牌。","detail_en":"Draw 1 extra card on Turn 2."},
...
const RELICS = [
	...
	{"id":"windChime","icon":"≋","icon_mark":"wave","color":"78e9ff","zh":"引灵风铃","en":"Spirit Chime","detail":"第 2 回合额外抽 2 张牌。","detail_en":"Draw 2 extra cards on Turn 2."},
