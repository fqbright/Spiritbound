...
const ENEMIES: Array[Dictionary] = [
	# =========================================================================
	# REALM 1: 灵木与熔炉 (Mistwood & Ancient Forge) - Chapters 1 to 10
	# =========================================================================
	# Minions (Tier 1)
	{"id":"m_r1_01", "realm":1, "tier":1, "element":"wood", "tint":"83e4c1", "name":"巡林石偶", "name_en":"Grove Sentry", "art":"res://assets/characters/monsters/m_r1_01.png", "art_key":"m_r1_01", "lore":"守护灵木边缘的古老石偶，以林间灵气为源泉，沉默地驱逐入侵者。", "lore_en":"An ancient stone effigy guarding the grove's verge, silently repelling intruders."},
	{"id":"m_r1_02", "realm":1, "tier":1, "element":"wood", "tint":"75d7d2", "name":"雾林影鸦", "name_en":"Mist Raven", "art":"res://assets/characters/monsters/m_r1_02.png", "art_key":"m_r1_02", "lore":"栖息于迷雾林冠的黑羽鸦群，常成群结队掠夺旅人的心智灵光。", "lore_en":"Crows dwelling in the high misty boughs, preying in flocks upon wayfarers' wits."},
	{"id":"m_r1_03", "realm":1, "tier":1, "element":"earth", "tint":"88b04b", "name":"苔痕石蛛", "name_en":"Moss Weaver", "art":"res://assets/characters/monsters/m_r1_03.png", "art_key":"m_r1_03", "lore":"常年蛰伏于潮湿石壁的硬壳生灵，以坚韧石丝设下重重绊足网。", "lore_en":"Shelled lurkers camouflaged on damp stones, weaving tough stone threads to ensnare prey."},
	{"id":"m_r1_04", "realm":1, "tier":1, "element":"earth", "tint":"66cdaa", "name":"灵泉水灵", "name_en":"Spring Wisp", "art":"res://assets/characters/monsters/m_r1_04.png", "art_key":"m_r1_04", "lore":"清澈泉眼汇聚而成的纯净灵体，受到惊扰时会化作刺骨湍流。", "lore_en":"A pure sprite born of pristine springs, whipping into a chilly current when startled."},
	{"id":"m_r1_05", "realm":1, "tier":1, "element":"fire", "tint":"f0b16d", "name":"熔渣火灵", "name_en":"Slag Sprite", "art":"res://assets/characters/monsters/m_r1_05.png", "art_key":"m_r1_05", "lore":"古代锻炉残渣中跃动的微弱火苗，虽身形细小却极度灼热暴躁。", "lore_en":"A spark flickering from ancient hearth residue, tiny yet blazing with fierce temperament."},
	{"id":"m_r1_06", "realm":1, "tier":1, "element":"wood", "tint":"7bc043", "name":"刺藤恶犬", "name_en":"Briar Hound", "art":"res://assets/characters/monsters/m_r1_06.png", "art_key":"m_r1_06", "lore":"浑身缠绕荆棘倒刺的荒原野兽，狂奔时会在泥地上撕开渗血沟壑。", "lore_en":"A wild beast wrapped in thorny briars, gouging bloody furrows into the earth as it charges."},
	{"id":"m_r1_07", "realm":1, "tier":1, "element":"earth", "tint":"d4a373", "name":"碎石守卫", "name_en":"Pebble Sentry", "art":"res://assets/characters/monsters/m_r1_07.png", "art_key":"m_r1_07", "lore":"由地底灵脉震碎的矿核拼凑而成，能随地底岩石共振以加固外壳。", "lore_en":"Assembled from shattered mineral cores, resonating with bedrock to harden its plating."},
	# Elites (Tier 2)
	{"id":"m_r1_08", "realm":1, "tier":2, "element":"wood", "tint":"5ec880", "name":"碧叶卫士", "name_en":"Verdant Guard", "art":"res://assets/characters/monsters/m_r1_08.png", "art_key":"m_r1_08", "lore":"古木祭司留下的精锐武士，体内流淌着长青灵汁，生命力极其顽强。", "lore_en":"Elite warriors of the ancient arbor priests, sustained by evergreen sap with unyielding vitality."},
	{"id":"m_r1_09", "realm":1, "tier":2, "element":"fire", "tint":"ff6b6b", "name":"炽火行者", "name_en":"Cinder Strider", "art":"res://assets/characters/monsters/m_r1_09.png", "art_key":"m_r1_09", "lore":"涉足火山余烬的高大火怪，每踏出一步都会令脚下泥石化作沸腾熔岩。", "lore_en":"A hulking firewalker wading in embers, turning stone beneath its hooves into boiling lava."},
	{"id":"m_r1_10", "realm":1, "tier":2, "element":"earth", "tint":"c2b280", "name":"坚石战魁", "name_en":"Granite Mauler", "art":"res://assets/characters/monsters/m_r1_10.png", "art_key":"m_r1_10", "lore":"花岗巨石雕刻出的巨型战争傀儡，双拳挥动时足以震裂山谷峭壁。", "lore_en":"A heavy war automaton carved from granite, whose crushing fists can split cliff faces."},
	{"id":"m_r1_11", "realm":1, "tier":2, "element":"wood", "tint":"9b59b6", "name":"暮光夜鸦", "name_en":"Duskwing Raven", "art":"res://assets/characters/monsters/m_r1_11.png", "art_key":"m_r1_11", "lore":"在黄昏交界处巡狩的巨型鸦妖，双翼挥动时掀起的狂风夹带刺骨死意。", "lore_en":"A giant raven hunting the dusk horizon, beating its wings to unleash a chilling gale."},
	{"id":"m_r1_12", "realm":1, "tier":2, "element":"fire", "tint":"e67e22", "name":"熔火侍祭", "name_en":"Molten Acolyte", "art":"res://assets/characters/monsters/m_r1_12.png", "art_key":"m_r1_12", "lore":"盲目崇拜神火的苦修者遗蜕，以身躯饲养烈焰，散发着骇人的毁灭高热。", "lore_en":"Remnants of zealots worshipping primal fire, feeding flames with their flesh to radiate scorching heat."},
	{"id":"m_r1_13", "realm":1, "tier":2, "element":"earth", "tint":"58b8ff", "name":"符文探求者", "name_en":"Rune Seeker", "art":"res://assets/characters/monsters/m_r1_13.png", "art_key":"m_r1_13", "lore":"追逐上古铭文的石甲游侠，周身铭刻三道防御灵印，寻常兵刃难伤分毫。", "lore_en":"A stone-clad nomad chasing ancient inscriptions, shielded by defensive glyphs impervious to mundane blades."},
	{"id":"m_r1_14", "realm":1, "tier":2, "element":"wood", "tint":"27ae60", "name":"铁棘凶兽", "name_en":"Ironthorn Behemoth", "art":"res://assets/characters/monsters/m_r1_14.png", "art_key":"m_r1_14", "lore":"吞食玄铁长成的刺棘恶兽，外皮坚若铁板，任何近战打击都会招致惨烈反刺。", "lore_en":"A feral beast that fed on meteoric iron, whose iron-hard hide brutally retaliates against melee strikes."},
	{"id":"m_r1_15", "realm":1, "tier":2, "element":"fire", "tint":"e74c3c", "name":"赤焰火灵主", "name_en":"Blaze Pyromancer", "art":"res://assets/characters/monsters/m_r1_15.png", "art_key":"m_r1_15", "lore":"统治熔渣群灵的赤焰灵巫，手中炽火法球能引动地底岩浆连环喷涌。", "lore_en":"A pyromancer sovereign ruling over lesser sparks, conjuring cascading eruptions of magma."},
	# Bosses (Tier 3 & 4)
	{"id":"m_r1_16", "realm":1, "tier":3, "element":"wood", "tint":"83e4c1", "name":"雾林守卫", "name_en":"Mistwood Sentinel", "art":"res://assets/characters/monsters/m_r1_16.png", "art_key":"m_r1_16", "lore":"游荡于雾林间的古老哨兵，行动迟缓但极难被击溃。", "lore_en":"An ancient sentinel wandering the misty woods — slow, but brutally hard to bring down."},
	{"id":"m_r1_17", "realm":1, "tier":3, "element":"fire", "tint":"f0932b", "name":"烬河领主", "name_en":"Ashriver Lord", "art":"res://assets/characters/monsters/m_r1_17.png", "art_key":"m_r1_17", "lore":"统领烬河枯滩的烈火暴君，灰烬战刀出鞘时天地皆陷入炽烈焦灼。", "lore_en":"A tyrant commanding the ash river flats, scorching heaven and earth whenever his blade is drawn."},
	{"id":"m_r1_18", "realm":1, "tier":3, "element":"earth", "tint":"eb4d4b", "name":"雷云战魁", "name_en":"Thunder Peak Goliath", "art":"res://assets/characters/monsters/m_r1_18.png", "art_key":"m_r1_18", "lore":"伫立于孤峰顶端的擎天战神，引九天雷霆为甲，招式沉重如山崩。", "lore_en":"A towering warrior astride thunderous peaks, clad in lightning mail with strikes heavy as rockfalls."},
	{"id":"m_r1_19", "realm":1, "tier":3, "element":"earth", "tint":"f9ca24", "name":"边陲石卫长", "name_en":"Border Fortress Commander", "art":"res://assets/characters/monsters/m_r1_19.png", "art_key":"m_r1_19", "lore":"死守边陲要塞千百年的古老统帅，誓言不灭，其防御固若金汤。", "lore_en":"A commander holding an ancient border fortress across centuries, his oath unbreakable and armor impenetrable."},
	{"id":"m_r1_20", "realm":1, "tier":3, "element":"wood", "tint":"6ab04c", "name":"荆棘腐毒巨兽", "name_en":"Briar Abomination", "art":"res://assets/characters/monsters/m_r1_20.png", "art_key":"m_r1_20", "lore":"深渊剧毒侵蚀巨树后诞生的畸变怪物，挥舞毒蔓，所过之处寸草不生。", "lore_en":"An aberration mutated from ancient roots tainted by poison, lashing tendrils that wither all life."},
	{"id":"m_r1_21", "realm":1, "tier":3, "element":"water", "tint":"22a6b3", "name":"潮滩灵主", "name_en":"Tideflat Sovereign", "art":"res://assets/characters/monsters/m_r1_21.png", "art_key":"m_r1_21", "lore":"沉眠于潮汐涨落间的巨灵，能操控暗潮与浪花将一切闯入者卷入深海。", "lore_en":"A giant slumbering in tidal flats, commanding undersea undertows to drag intruders into the depths."},
	{"id":"m_r1_22", "realm":1, "tier":3, "element":"wood", "tint":"be2edd", "name":"祭坛灵祝尊者", "name_en":"Altar Hierophant", "art":"res://assets/characters/monsters/m_r1_22.png", "art_key":"m_r1_22", "lore":"守护灵狐祖祠的远古大祭司，持青玉法杖引动护山大阵，仙光璀璨。", "lore_en":"An ancient hierophant guarding the ancestral shrine, wielding jade scepters to awaken grand protective wards."},
	{"id":"m_r1_23", "realm":1, "tier":3, "element":"wood", "tint":"4834d4", "name":"幻雾夜魅妖尊", "name_en":"Mirage Phantasm", "art":"res://assets/characters/monsters/m_r1_23.png", "art_key":"m_r1_23", "lore":"隐遁于海市蜃楼深处的魅影之王，擅长窥探敌手心魔并将其化为致命刀刃。", "lore_en":"A phantasmal sovereign in mirage mists, manifesting travelers' deepest dread as razor-sharp blades."},
	{"id":"m_r1_24", "realm":1, "tier":3, "element":"fire", "tint":"f0b16d", "name":"烬崖守护者", "name_en":"Embercliff Guardian", "art":"res://assets/characters/monsters/m_r1_24.png", "art_key":"m_r1_24", "lore":"栖息于烬崖的守护者，愤怒时攻击力会持续攀升。", "lore_en":"A guardian dwelling on the ember cliffs, growing more dangerous the longer a fight drags on."},
	{"id":"m_r1_25", "realm":1, "tier":4, "element":"earth", "tint":"e67c65", "name":"山岳之心", "name_en":"Heart of the Mountain", "art":"res://assets/characters/monsters/m_r1_25.png", "art_key":"m_r1_25", "lore":"整座山脉的意志凝聚而成，是每十章尽头等待着的终极考验。", "lore_en":"The will of an entire mountain given form — the ultimate trial waiting at the end of the realm."},

	# =========================================================================
	# REALM 2: 幽泽与沉沦古都 (Nether Marsh & Sunken Dynasty) - Chapters 11 to 20
	# =========================================================================
	# Minions (Tier 1)
	{"id":"m_r2_01", "realm":2, "tier":1, "element":"water", "tint":"3498db", "name":"腐泥水怪", "name_en":"Mire Slime", "art":"res://assets/characters/monsters/m_r2_01.png", "art_key":"m_r2_01", "lore":"幽沼深处腐烂枝叶孕育的黏液软泥，能吸收并卸去钝器重击。", "lore_en":"Acidic slime spawned in deep bog depths, absorbing and dampening blunt concussions."},
	{"id":"m_r2_02", "realm":2, "tier":1, "element":"water", "tint":"1abc9c", "name":"幽沼幽火", "name_en":"Bog Spark", "art":"res://assets/characters/monsters/m_r2_02.png", "art_key":"m_r2_02", "lore":"在水面上漂浮的青绿鬼火，诱使迷途旅人步入无底泥潭。", "lore_en":"Pale jade will-o'-the-wisps dancing over murky water, luring travelers into bottomless mires."},
	{"id":"m_r2_03", "realm":2, "tier":1, "element":"void", "tint":"bdc3c7", "name":"枯骨步卒", "name_en":"Rattlebone Footman", "art":"res://assets/characters/monsters/m_r2_03.png", "art_key":"m_r2_03", "lore":"沉沦古国覆灭时遗留的甲胄枯骨，凭借生前的战斗本能挥动残剑。", "lore_en":"Skeletal infantry from a fallen dynasty, swinging rusted blades by muscle memory of ancient wars."},
	{"id":"m_r2_04", "realm":2, "tier":1, "element":"water", "tint":"e74c3c", "name":"泣血水草妖", "name_en":"Bloodreed Sprout", "art":"res://assets/characters/monsters/m_r2_04.png", "art_key":"m_r2_04", "lore":"饮足亡者鲜血滋生出的嗜血水草，尖刺中含有使伤口难以愈合的毒素。", "lore_en":"Carnivorous reeds nourished by fallen blood, tipped with toxins that prevent wounds from closing."},
	{"id":"m_r2_05", "realm":2, "tier":1, "element":"poison", "tint":"9b59b6", "name":"蚀骨毒蝎", "name_en":"Acid Stinger", "art":"res://assets/characters/monsters/m_r2_05.png", "art_key":"m_r2_05", "lore":"潜伏在泥沙底层的剧毒巨蝎，高耸的尾钩能轻易刺穿重甲护具。", "lore_en":"A toxic arachnid lurking in wet sands, its barbed tail easily punching through reinforced mail."},
	{"id":"m_r2_06", "realm":2, "tier":1, "element":"water", "tint":"2980b9", "name":"沉船恶灵", "name_en":"Sunken Skulker", "art":"res://assets/characters/monsters/m_r2_06.png", "art_key":"m_r2_06", "lore":"溺毙水手无法超脱的怨魂，手持锈蚀船锚寻找替死鬼。", "lore_en":"Restless spirits of drowned sailors, dragging rusted anchors to pull the living into cold depths."},
	{"id":"m_r2_07", "realm":2, "tier":1, "element":"void", "tint":"7f8c8d", "name":"怨风残魂", "name_en":"Grievance Shade", "art":"res://assets/characters/monsters/m_r2_07.png", "art_key":"m_r2_07", "lore":"峡谷狂风中飘荡的不散阴魂，其哀号声能削弱勇士的斗志与警惕。", "lore_en":"Ghostly shades drifting on canyon winds, whose chilling wails erode stamina and resolve."},
	# Elites (Tier 2)
	{"id":"m_r2_08", "realm":2, "tier":2, "element":"water", "tint":"75d7d2", "name":"提灯石卫", "name_en":"Lanternstone Keeper", "art":"res://assets/characters/monsters/m_r2_08.png", "art_key":"m_r2_08", "lore":"以石灯照亮回廊的守望者，偏好稳固防御与反复布阵。", "lore_en":"A watcher lighting the corridors with stone lanterns, favoring steady defense over aggression."},
	{"id":"m_r2_09", "realm":2, "tier":2, "element":"poison", "tint":"2ecc71", "name":"剧毒巨蟾", "name_en":"Blight Toad", "art":"res://assets/characters/monsters/m_r2_09.png", "art_key":"m_r2_09", "lore":"吞食沼泽瘴气千百年的巨型毒蟾，喷吐出的毒雾足以腐蚀岩石甲胄。", "lore_en":"A gargantuan toad swollen with ancient toxins, exhaling miasmic clouds that dissolve armor."},
	{"id":"m_r2_10", "realm":2, "tier":2, "element":"void", "tint":"ecf0f1", "name":"枯骨先锋", "name_en":"Skeleton Vanguard", "art":"res://assets/characters/monsters/m_r2_10.png", "art_key":"m_r2_10", "lore":"生前为御林军领队的凶悍白骨，身披残破重铠，大盾坚不可摧。", "lore_en":"A bone captain of the imperial guard, holding a battered grand tower shield with eternal discipline."},
	{"id":"m_r2_11", "realm":2, "tier":2, "element":"water", "tint":"16a085", "name":"怨沼鳄魁", "name_en":"Murk Crocodile", "art":"res://assets/characters/monsters/m_r2_11.png", "art_key":"m_r2_11", "lore":"潜伏于泥浆深潭的沼泽霸王，巨颚咬合力足以粉碎万斤巨石。", "lore_en":"An apex predator resting in silt shallows, whose snapping jaws crush boulders with effortless ferocity."},
	{"id":"m_r2_12", "realm":2, "tier":2, "element":"water", "tint":"2c3e50", "name":"沉沦禁卫", "name_en":"Sunken Royal Guard", "art":"res://assets/characters/monsters/m_r2_12.png", "art_key":"m_r2_12", "lore":"守护古国寝宫的精英甲士，即使肉身腐朽仍坚守卫戍阵位。", "lore_en":"Elite palace guards submerged with their fallen kingdom, defending ruined royal chambers even in decay."},
	{"id":"m_r2_13", "realm":2, "tier":2, "element":"poison", "tint":"c0392b", "name":"啼血夜鸮", "name_en":"Bloodmoon Strix", "art":"res://assets/characters/monsters/m_r2_13.png", "art_key":"m_r2_13", "lore":"血月升起时现身的凶戾妖禽，双目能看穿虚实并降下嗜血诅咒。", "lore_en":"A sinister avian manifesting under blood moons, whose piercing gaze hexes foes with hemotoxins."},
	{"id":"m_r2_14", "realm":2, "tier":2, "element":"void", "tint":"8e44ad", "name":"幽冥裁决者", "name_en":"Nether Arbiter", "art":"res://assets/characters/monsters/m_r2_14.png", "art_key":"m_r2_14", "lore":"手持冥铁天平的审判幽魂，衡量生死，专斩意志动摇之辈。", "lore_en":"A spectral judge bearing infernal scales, executing souls whose resolve falters."},
	{"id":"m_r2_15", "realm":2, "tier":2, "element":"void", "tint":"34495e", "name":"裂谷猎手", "name_en":"Rift Shadowstalker", "art":"res://assets/characters/monsters/m_r2_15.png", "art_key":"m_r2_15", "lore":"无声穿梭于深渊裂隙的刺客死灵，出刃无声，见血封喉。", "lore_en":"A silent assassin phasing between ravine shadows, striking vital points with poisoned daggers."},
	# Bosses (Tier 3 & 4)
	{"id":"m_r2_16", "realm":2, "tier":3, "element":"void", "tint":"95a5a6", "name":"废都守墓使", "name_en":"Sunken City Mortician", "art":"res://assets/characters/monsters/m_r2_16.png", "art_key":"m_r2_16", "lore":"为整座沉沦王都举行永恒葬礼的古老死神，掌握操纵百鬼之术。", "lore_en":"The undertaker officiating an eternal wake for the sunken empire, raising legions of the dead."},
	{"id":"m_r2_17", "realm":2, "tier":3, "element":"water", "tint":"3498db", "name":"惊魂漩涡主", "name_en":"Maelstrom Phantasm", "art":"res://assets/characters/monsters/m_r2_17.png", "art_key":"m_r2_17", "lore":"盘踞幽冥死水漩涡中央的水魄暴君，能以怒涛重击撕裂一切舟楫与肉躯。", "lore_en":"A leviathan nesting in abyssal whirlpools, crushing armor and resolve beneath torrential waves."},
	{"id":"m_r2_18", "realm":2, "tier":3, "element":"void", "tint":"9b59b6", "name":"往生回廊怨母", "name_en":"Corridor Broodmother", "art":"res://assets/characters/monsters/m_r2_18.png", "art_key":"m_r2_18", "lore":"在无尽回廊中徘徊的千年怨母，能将死者最后的执念化作自爆鬼子。", "lore_en":"A malevolent matriarch haunting infinite corridors, weaving dying regrets into explosive apparitions."},
	{"id":"m_r2_19", "realm":2, "tier":3, "element":"poison", "tint":"e74c3c", "name":"血月双生祭司", "name_en":"Bloodmoon Dualist", "art":"res://assets/characters/monsters/m_r2_19.png", "art_key":"m_r2_19", "lore":"背靠背相连的血月主仆，一攻一守，招式变换无常，令挑战者防不胜防。", "lore_en":"Twin sacerdotal spirits bound back-to-back, coordinating flawless offensive barrages and iron barriers."},
	{"id":"m_r2_20", "realm":2, "tier":3, "element":"poison", "tint":"8e44ad", "name":"蚀骨瘴雾母祖", "name_en":"Acid Miasma Empress", "art":"res://assets/characters/monsters/m_r2_20.png", "art_key":"m_r2_20", "lore":"瘴气源头的至尊毒母，每一缕呼吸都能让金铁化水、生灵化骨。", "lore_en":"Empress seated at the nexus of acid fog, whose single exhalation liquifies both metal and marrow."},
	{"id":"m_r2_21", "realm":2, "tier":3, "element":"void", "tint":"bdc3c7", "name":"亡陵守陵王", "name_en":"Silent Necropolis King", "art":"res://assets/characters/monsters/m_r2_21.png", "art_key":"m_r2_21", "lore":"寂静寝陵中的不朽帝皇，虽言语沉寂，但威严金剑能号令百万枯骨同击。", "lore_en":"The immortal emperor of the silent necropolis, commanding myriads of skeleton legions with a royal sword."},
	{"id":"m_r2_22", "realm":2, "tier":3, "element":"poison", "tint":"1abc9c", "name":"撕风羽魔尊", "name_en":"Gale-Rending Fiend", "art":"res://assets/characters/monsters/m_r2_22.png", "art_key":"m_r2_22", "lore":"在深渊裂风中诞生的羽翼狂魔，钢羽如飞刀倾泻，快逾惊雷。", "lore_en":"A winged demon forged in abyss gales, shooting steel feathers faster than storm squalls."},
	{"id":"m_r2_23", "realm":2, "tier":3, "element":"void", "tint":"7f8c8d", "name":"聚魂魔棺", "name_en":"Soul-Harvesting Sarcophagus", "art":"res://assets/characters/monsters/m_r2_23.png", "art_key":"m_r2_23", "lore":"漂浮于虚空中的远古青铜魔棺，棺盖微启时会贪婪鲸吞所有游离灵魂。", "lore_en":"An ancient bronze sarcophagus levitating in void, devouring wandering spirits whenever its lid parts."},
	{"id":"m_r2_24", "realm":2, "tier":3, "element":"void", "tint":"2c3e50", "name":"影渊暗影暴君", "name_en":"Umbral Shadow Tyrant", "art":"res://assets/characters/monsters/m_r2_24.png", "art_key":"m_r2_24", "lore":"吞噬千万灵魂后膨胀的至暗阴影，身体任何部分皆可化作斩灭万物的魔刃。", "lore_en":"A gargantuan shadow nourished on thousands of spirits, reshaping its silhouette into obsidian scythes."},
	{"id":"m_r2_25", "realm":2, "tier":4, "element":"void", "tint":"e67c65", "name":"冥王白骨至尊", "name_en":"Sovereign of the Empty Throne", "art":"res://assets/characters/monsters/m_r2_25.png", "art_key":"m_r2_25", "lore":"空置千年的幽冥王座本体所化至高主宰，散发着统御一切亡魂的绝对天灾意志。", "lore_en":"The sovereign born from the millennium-vacant nether throne, radiating cataclysmic dominion over the dead."},

	# =========================================================================
	# REALM 3: 云海与苍穹神域 (Cloudsea Heights & Storm Domain) - Chapters 21 to 30
	# =========================================================================
	# Minions (Tier 1)
	{"id":"m_r3_01", "realm":3, "tier":1, "element":"wind", "tint":"a8e6cf", "name":"云海浮灵", "name_en":"Cloud Wisp", "art":"res://assets/characters/monsters/m_r3_01.png", "art_key":"m_r3_01", "lore":"漂浮在高空云絮中的微风灵光，受气流牵引能迅速避开袭来的攻击。", "lore_en":"A light wisp dancing on alpine cirrus, gliding effortlessly to evade direct incoming strikes."},
	{"id":"m_r3_02", "realm":3, "tier":1, "element":"wind", "tint":"dcedc1", "name":"疾风雷雏", "name_en":"Gust Hatchling", "art":"res://assets/characters/monsters/m_r3_02.png", "art_key":"m_r3_02", "lore":"生于雷暴云团中的幼鸟，羽翼未丰但啼叫声已蕴含细碎电弧。", "lore_en":"A young avian born within thunderclouds, chirping miniature arcs of static voltage."},
	{"id":"m_r3_03", "realm":3, "tier":1, "element":"celestial", "tint":"ffd3b6", "name":"极光微光虫", "name_en":"Aurora Midge", "art":"res://assets/characters/monsters/m_r3_03.png", "art_key":"m_r3_03", "lore":"吸食极光能量生长的浮空甲虫，能释放刺目的幻彩眩光干扰敌手视线。", "lore_en":"Luminescent airborne beetles that feed on aurora rays, blinking blinding rainbows to disorient foes."},
	{"id":"m_r3_04", "realm":3, "tier":1, "element":"wind", "tint":"ff8b94", "name":"罡风石鹰", "name_en":"Gale Stone Falcon", "art":"res://assets/characters/monsters/m_r3_04.png", "art_key":"m_r3_04", "lore":"被万年绝顶狂风雕刻成形的石鹰，扑击俯冲时声如裂帛撕空。", "lore_en":"A raptor carved by eons of mountaintop gales, screaming through air with divebomb velocity."},
	{"id":"m_r3_05", "realm":3, "tier":1, "element":"thunder", "tint":"58b8ff", "name":"闪电火花妖", "name_en":"Static Sprite", "art":"res://assets/characters/monsters/m_r3_05.png", "art_key":"m_r3_05", "lore":"悬崖岩壁摩擦积蓄放电凝成的精灵，游走不定，极度易怒危险。", "lore_en":"A living spark generated by cliffside tectonic friction, erratic and volatile."},
	{"id":"m_r3_06", "realm":3, "tier":1, "element":"wind", "tint":"d4a373", "name":"浮空碎岩", "name_en":"Levitating Shard", "art":"res://assets/characters/monsters/m_r3_06.png", "art_key":"m_r3_06", "lore":"因反重力符文常年不灭而浮空的石块，受本能驱使向靠近者激射飞射。", "lore_en":"A rock levitating on anti-gravity leylines, instinctively flinging itself at intruders."},
	{"id":"m_r3_07", "realm":3, "tier":1, "element":"celestial", "tint":"ffd700", "name":"幻日迷蝶", "name_en":"Solar Mirage Moth", "art":"res://assets/characters/monsters/m_r3_07.png", "art_key":"m_r3_07", "lore":"双翼折射烈日金光的灵蝶，磷粉飘落处会制造真实难辨的太阳残影。", "lore_en":"A moth whose golden wings refract sunlight, casting dazzling solar phantoms."},
	# Elites (Tier 2)
	{"id":"m_r3_08", "realm":3, "tier":2, "element":"thunder", "tint":"a3c8ff", "name":"缚文巨像", "name_en":"Runebound Colossus", "art":"res://assets/characters/monsters/m_r3_08.png", "art_key":"m_r3_08", "lore":"由古老符文束缚而成的巨像，力大无穷，招式沉重。", "lore_en":"A colossus bound by ancient runes, immense in strength and weighty in every strike."},
	{"id":"m_r3_09", "realm":3, "tier":2, "element":"wind", "tint":"70a1ff", "name":"苍穹巡卫", "name_en":"Firmament Patrol", "art":"res://assets/characters/monsters/m_r3_09.png", "art_key":"m_r3_09", "lore":"翱翔于天幕回廊的天兵守卫，手持风雷长枪，冲杀势如破竹。", "lore_en":"Celestial guards patrolling the high heavens, wielding storm spears to pierce through frontline defenses."},
	{"id":"m_r3_10", "realm":3, "tier":2, "element":"celestial", "tint":"7bed9f", "name":"极光守望者", "name_en":"Aurora Sentinel", "art":"res://assets/characters/monsters/m_r3_10.png", "art_key":"m_r3_10", "lore":"将极光冻结为护甲的冰天卫士，周身回荡着亘古不灭的空灵圣歌。", "lore_en":"A frozen sentinel draped in solidified aurora, accompanied by immortal celestial chants."},
	{"id":"m_r3_11", "realm":3, "tier":2, "element":"celestial", "tint":"eccc68", "name":"坠星傀儡", "name_en":"Starfall Golem", "art":"res://assets/characters/monsters/m_r3_11.png", "art_key":"m_r3_11", "lore":"由天外陨铁构筑的坚固魔像，体内星核仍保持着天外星辰坠落的高热。", "lore_en":"A golem forged from fallen meteoric iron, retaining the fiery heat of descent inside its core."},
	{"id":"m_r3_12", "realm":3, "tier":2, "element":"wind", "tint":"2ed573", "name":"狂风使徒", "name_en":"Tempest Apostle", "art":"res://assets/characters/monsters/m_r3_12.png", "art_key":"m_r3_12", "lore":"狂热信奉无上天风的狂风狂信者，以风刃为翼，在气旋中起舞杀敌。", "lore_en":"A fanatic worshipper of boundless wind, cutting through air with wings of razor gale."},
	{"id":"m_r3_13", "realm":3, "tier":2, "element":"thunder", "tint":"1e90ff", "name":"天工机关人", "name_en":"Skycraft Automaton", "art":"res://assets/characters/monsters/m_r3_13.png", "art_key":"m_r3_13", "lore":"古代神工巧匠制造的精密机关战偶，发条驱动的雷电齿轮转动不息。", "lore_en":"An intricate clockwork automaton engineered by ancient skywrights, humming with electric cogs."},
	{"id":"m_r3_14", "realm":3, "tier":2, "element":"thunder", "tint":"3742fa", "name":"雷霆祭司", "name_en":"Thunder Shaman", "art":"res://assets/characters/monsters/m_r3_14.png", "art_key":"m_r3_14", "lore":"掌握引雷秘术的苍穹巫祝，高举引雷幡引下九天神雷惩戒闯入者。", "lore_en":"A sky shaman commanding lightning rites, drawing heavenly bolts to cleanse trespassing souls."},
	{"id":"m_r3_15", "realm":3, "tier":2, "element":"wind", "tint":"57606f", "name":"悬空牢狱卒", "name_en":"Sky-Prison Warden", "art":"res://assets/characters/monsters/m_r3_15.png", "art_key":"m_r3_15", "lore":"奉命看守悬空天牢的铁面看守，挥动沉重的拘魂锁链禁锢一切生灵。", "lore_en":"An iron-masked jailer guarding skyborne dungeons, swinging weighty soul-binding chains."},
	# Bosses (Tier 3 & 4)
	{"id":"m_r3_16", "realm":3, "tier":3, "element":"wind", "tint":"70a1ff", "name":"孤峰云海枭皇", "name_en":"Cloudsea Apex Falcon", "art":"res://assets/characters/monsters/m_r3_16.png", "art_key":"m_r3_16", "lore":"盘旋于云海之巅的猛禽霸主，振翼即可掀起撕裂山川的无边狂飙。", "lore_en":"The sovereign apex falcon soaring above cloud oceans, whipping up gales that carve mountains."},
	{"id":"m_r3_17", "realm":3, "tier":3, "element":"thunder", "tint":"5352ed", "name":"天堑雷霆巨兽", "name_en":"Sky-Chasm Thunder Titan", "art":"res://assets/characters/monsters/m_r3_17.png", "art_key":"m_r3_17", "lore":"长年游走于云裂深处的实体化雷兽，每声咆哮都会引发万道雷鸣连锁。", "lore_en":"A solid thunder leviathan wandering the cloud abysses, sparking chains of lightning with each roar."},
	{"id":"m_r3_18", "realm":3, "tier":3, "element":"wind", "tint":"2ed573", "name":"远古风暴神像", "name_en":"Ancient Tempest Idol", "art":"res://assets/characters/monsters/m_r3_18.png", "art_key":"m_r3_18", "lore":"千万年前信徒供奉的风暴图腾，在烈风洗礼下化为拥有神格的巨灵。", "lore_en":"A primordial tempest totem worshipped by ancient pilgrims, infused with divine gale sentience."},
	{"id":"m_r3_19", "realm":3, "tier":3, "element":"celestial", "tint":"ffa502", "name":"坠星天外来客", "name_en":"Meteor Extraterrestrial", "art":"res://assets/characters/monsters/m_r3_19.png", "art_key":"m_r3_19", "lore":"跟随流星自外域星空降临的异域生灵，周身环绕着不属于此界的星辰法则。", "lore_en":"An extraterrestrial visitor arriving on shooting stars, wreathed in stellar laws alien to this world."},
	{"id":"m_r3_20", "realm":3, "tier":3, "element":"celestial", "tint":"7bed9f", "name":"冻魂极光主母", "name_en":"Aurora Soul Matron", "art":"res://assets/characters/monsters/m_r3_20.png", "art_key":"m_r3_20", "lore":"统御极光冰原的冷艳女王，挥舞冰晶权杖将万物灵魂永恒冰封于光芒中。", "lore_en":"The sovereign matron of the aurora steppes, sealing souls within permanent, glistening frost."},
	{"id":"m_r3_21", "realm":3, "tier":3, "element":"thunder", "tint":"1e90ff", "name":"天工要塞核心", "name_en":"Skycraft Core Leviathan", "art":"res://assets/characters/monsters/m_r3_21.png", "art_key":"m_r3_21", "lore":"古代浮空战舰的中枢主脑，即使船体碎裂仍恪尽职守执行歼灭指令。", "lore_en":"The central mainframe of an ancient aerial fortress, executing annihilation protocols with unflinching logic."},
	{"id":"m_r3_22", "realm":3, "tier":3, "element":"celestial", "tint":"ff4757", "name":"界外天眼观察者", "name_en":"Outworld Watcher", "art":"res://assets/characters/monsters/m_r3_22.png", "art_key":"m_r3_22", "lore":"透过天穹裂隙向下窥探的庞大巨瞳，目光触及之处时空发生不可逆扭曲。", "lore_en":"A colossal cosmic eye gazing through sky fissures, twisting space-time wherever its pupil fixates."},
	{"id":"m_r3_23", "realm":3, "tier":3, "element":"celestial", "tint":"eccc68", "name":"星轨祭司长老", "name_en":"Stellar Orbit Elder", "art":"res://assets/characters/monsters/m_r3_23.png", "art_key":"m_r3_23", "lore":"观测群星轨迹数千年的盲目先知，掌握挪移星辰轨迹压制对手的大神通。", "lore_en":"A blind oracle tracking stellar constellations across millennia, shifting cosmic orbits to crush foes."},
	{"id":"m_r3_24", "realm":3, "tier":3, "element":"wind", "tint":"2f3542", "name":"天牢罪孽化身", "name_en":"Sky-Prison Abomination", "art":"res://assets/characters/monsters/m_r3_24.png", "art_key":"m_r3_24", "lore":"悬空天牢无数重犯怨念汇聚而成的恐怖怪物，渴望将整个苍穹拉入永劫狂乱。", "lore_en":"A towering abomination coalesced from prisoners' malice, eager to drag the sky into eternal insanity."},
	{"id":"m_r3_25", "realm":3, "tier":4, "element":"thunder", "tint":"e67c65", "name":"苍穹风暴神皇", "name_en":"Storm Emperor of the Heavens", "art":"res://assets/characters/monsters/m_r3_25.png", "art_key":"m_r3_25", "lore":"高居风暴眼王座的苍穹主宰者，风暴本身即为其意志延伸，掌握天灾雷罚神权。", "lore_en":"The storm emperor enthroned in the eye of the gale, wielding supreme divine thunderbolts."},

	# =========================================================================
	# REALM 4: 虚空深渊与归墟裂痕 (Void Rift & Oblivion Trench) - Chapters 31 to 40
	# =========================================================================
	# Minions (Tier 1)
	{"id":"m_r4_01", "realm":4, "tier":1, "element":"void", "tint":"4834d4", "name":"虚空浮游", "name_en":"Void Larva", "art":"res://assets/characters/monsters/m_r4_01.png", "art_key":"m_r4_01", "lore":"在虚无与现实缝隙中滋生的细小寄生体，啃噬着周围所有微弱光亮。", "lore_en":"A void larva gestating in interdimensional seams, consuming trace amounts of illumination."},
	{"id":"m_r4_02", "realm":4, "tier":1, "element":"void", "tint":"686de0", "name":"湮灭微粒", "name_en":"Oblivion Spark", "art":"res://assets/characters/monsters/m_r4_02.png", "art_key":"m_r4_02", "lore":"世界瓦解破碎时剥落的虚无微尘，碰撞到实体物质会引发微型湮灭。", "lore_en":"Dust sloughed from collapsing realities, triggering minute annihilation bursts on physical impact."},
	{"id":"m_r4_03", "realm":4, "tier":1, "element":"void", "tint":"be2edd", "name":"裂隙之眼", "name_en":"Rift Eyeball", "art":"res://assets/characters/monsters/m_r4_03.png", "art_key":"m_r4_03", "lore":"附着在次元裂缝边缘的诡异眼球，不断眨动并向外渗透侵蚀神智的紫雾。", "lore_en":"A sinister ocular growth lining rift margins, blinking incessantly to exude sanity-draining violet mist."},
	{"id":"m_r4_04", "realm":4, "tier":1, "element":"void", "tint":"130f40", "name":"暗流噬魂者", "name_en":"Undertow Feeder", "art":"res://assets/characters/monsters/m_r4_04.png", "art_key":"m_r4_04", "lore":"潜伏于归墟暗流中的水状恶魔，伺机捕食所有被拉入深渊的魂魄。", "lore_en":"An amorphous demon haunting oblivion undertows, snatching souls dragged toward the abyss."},
	{"id":"m_r4_05", "realm":4, "tier":1, "element":"void", "tint":"535c68", "name":"遗忘尘埃", "name_en":"Dust of Oblivion", "art":"res://assets/characters/monsters/m_r4_05.png", "art_key":"m_r4_05", "lore":"失去一切记忆与色彩的灵魂残烬，能同化并淡化对手的护甲硬度。", "lore_en":"Ashen cinders of erased memories, gradually dissolving and softening opponents' shields."},
	{"id":"m_r4_06", "realm":4, "tier":1, "element":"genesis", "tint":"f0932b", "name":"碎星残核", "name_en":"Shattered Star Core", "art":"res://assets/characters/monsters/m_r4_06.png", "art_key":"m_r4_06", "lore":"在归墟中尚未完全熄灭的恒星残核，临近死亡却仍爆发着惊人重力压迫。", "lore_en":"A dying stellar core resisting oblivion, exerting crushing gravitational bursts."},
	{"id":"m_r4_07", "realm":4, "tier":1, "element":"void", "tint":"30336b", "name":"虚无畸体", "name_en":"Nullity Leech", "art":"res://assets/characters/monsters/m_r4_07.png", "art_key":"m_r4_07", "lore":"无形无相的虚无水蛭，吸附在对手躯体上持续偷取灵力与生命。", "lore_en":"A formless void leech clinging to physical hosts, continuously sapping spirit energy."},
	# Elites (Tier 2)
	{"id":"m_r4_08", "realm":4, "tier":2, "element":"void", "tint":"4834d4", "name":"虚空漫游者", "name_en":"Void Stalker", "art":"res://assets/characters/monsters/m_r4_08.png", "art_key":"m_r4_08", "lore":"在荒凉裂谷中巡弋的暗黑猎手，身形介于存在与虚无之间，飘忽不定。", "lore_en":"A shadow stalker patrolling barren chasms, flickering between reality and nothingness."},
	{"id":"m_r4_09", "realm":4, "tier":2, "element":"void", "tint":"be2edd", "name":"归墟先驱", "name_en":"Oblivion Herald", "art":"res://assets/characters/monsters/m_r4_09.png", "art_key":"m_r4_09", "lore":"高声宣告万物终焉的末日使者，手摇丧钟引动令时空震颤的毁灭共鸣。", "lore_en":"A doomsday herald proclaiming universal end, chiming funeral knells that shake reality."},
	{"id":"m_r4_10", "realm":4, "tier":2, "element":"void", "tint":"eb4d4b", "name":"湮灭剑侍", "name_en":"Annihilation Blademaiden", "art":"res://assets/characters/monsters/m_r4_10.png", "art_key":"m_r4_10", "lore":"手持湮灭黑刃的幽冷女武士，剑锋所过之处，物质世界无声崩解。", "lore_en":"A grim swordmaiden bearing void blades, silently cleaving through physical substance."},
	{"id":"m_r4_11", "realm":4, "tier":2, "element":"void", "tint":"22a6b3", "name":"噬光巨魔", "name_en":"Light Eater Behemoth", "art":"res://assets/characters/monsters/m_r4_11.png", "art_key":"m_r4_11", "lore":"以所有光谱为食的漆黑巨魔，周身十丈之内光芒皆被彻底吞没。", "lore_en":"An abyssal brute feeding on all wavelengths, devouring every beacon within its perimeter."},
	{"id":"m_r4_12", "realm":4, "tier":2, "element":"void", "tint":"6ab04c", "name":"遗世残岛守卫", "name_en":"Fractured Isle Sentry", "art":"res://assets/characters/monsters/m_r4_12.png", "art_key":"m_r4_12", "lore":"漂浮于虚空中的残破世界碎片上的最后卫士，誓死守护早已不复存在的故土。", "lore_en":"The lone sentry of a floating realm fragment, defending an extinct homeland with unyielding valor."},
	{"id":"m_r4_13", "realm":4, "tier":2, "element":"void", "tint":"e056fd", "name":"混沌低语者", "name_en":"Chaotic Whisperer", "art":"res://assets/characters/monsters/m_r4_13.png", "art_key":"m_r4_13", "lore":"收集破碎世界临终遗言的怪诞妖僧，口诵不可名状的混沌咒文折磨对手灵魂。", "lore_en":"A bizarre cultist cataloging final gasps of shattered worlds, reciting unspeakable hexes."},
	{"id":"m_r4_14", "realm":4, "tier":2, "element":"void", "tint":"686de0", "name":"终焉侍祭", "name_en":"Doomsday Acolyte", "art":"res://assets/characters/monsters/m_r4_14.png", "art_key":"m_r4_14", "lore":"沉醉于虚无伟力的黑袍狂信者，能献祭自身护盾换取排山倒海的毁灭冲击。", "lore_en":"A black-robed acolyte intoxicating himself on entropy, converting shielding into apocalyptic bursts."},
	{"id":"m_r4_15", "realm":4, "tier":2, "element":"void", "tint":"95afc0", "name":"残响行者", "name_en":"Echo Strider", "art":"res://assets/characters/monsters/m_r4_15.png", "art_key":"m_r4_15", "lore":"在归墟深处回荡的时空残响化形而成的影子，行动莫测，难以捉摸其真实方位。", "lore_en":"A manifestation of lingering echoes from deep oblivion, moving unpredictably between frames."},
	# Bosses (Tier 3 & 4)
	{"id":"m_r4_16", "realm":4, "tier":3, "element":"void", "tint":"be2edd", "name":"虚无微光行刑官", "name_en":"Voidlight Executioner", "art":"res://assets/characters/monsters/m_r4_16.png", "art_key":"m_r4_16", "lore":"在绝对黑暗中手握微光巨镰的无情刽子手，专门处决试图穿越虚无的逃亡者。", "lore_en":"A merciless headsman bearing a dim crescent scythe, executing those who dare cross the void."},
	{"id":"m_r4_17", "realm":4, "tier":3, "element":"void", "tint":"4834d4", "name":"归墟引渡古龙", "name_en":"Oblivion Ferry Drake", "art":"res://assets/characters/monsters/m_r4_17.png", "art_key":"m_r4_17", "lore":"游曳于归墟暗河上的幽暗骨龙，背负万千亡魂渡过终结之门，龙息带走一切生机。", "lore_en":"A pale skeletal drake sailing the dark rivers of oblivion, exhaling frost that strips away all vitality."},
	{"id":"m_r4_18", "realm":4, "tier":3, "element":"void", "tint":"130f40", "name":"记忆湮灭主宰", "name_en":"Memory Eradicator", "art":"res://assets/characters/monsters/m_r4_18.png", "art_key":"m_r4_18", "lore":"回廊深处吞噬万物经历与情感的魔灵，凡与其交手者，记忆皆会随战斗逐步瓦解。", "lore_en":"A demon erasing recollections and sensations, dissolving the mind as battle drags on."},
	{"id":"m_r4_19", "realm":4, "tier":3, "element":"void", "tint":"22a6b3", "name":"极暗食光魔尊", "name_en":"Abyssal Light Devourer", "art":"res://assets/characters/monsters/m_r4_19.png", "art_key":"m_r4_19", "lore":"深渊最底层的万魔至尊，能将一切外界带入的光热与灵力尽数化为滋养自身的养料。", "lore_en":"The supreme overlord of absolute darkness, transmuting foreign light and mana into nourishment."},
	{"id":"m_r4_20", "realm":4, "tier":3, "element":"genesis", "tint":"f0932b", "name":"破碎世界残意", "name_en":"Will of the Fractured World", "art":"res://assets/characters/monsters/m_r4_20.png", "art_key":"m_r4_20", "lore":"整座毁灭文明的残存意志融合体，汇聚无数生灵临终哀鸣，爆发惊天动地的悲愤狂力。", "lore_en":"The gestalt will of a ruined planetary civilization, channeling millions of souls' final wails into devastating strikes."},
	{"id":"m_r4_21", "realm":4, "tier":3, "element":"void", "tint":"eb4d4b", "name":"裂界狂乱神像", "name_en":"Chaos Colossus of the Rift", "art":"res://assets/characters/monsters/m_r4_21.png", "art_key":"m_r4_21", "lore":"被混乱法则撕裂后胡乱重组的古代神像，每个关节都在不受控制地爆发出狂暴灵能。", "lore_en":"An ancient divine statue torn and reshuffled by chaos, leaking untamed cosmic energies at every joint."},
	{"id":"m_r4_22", "realm":4, "tier":3, "element":"void", "tint":"686de0", "name":"归墟门扉看守神", "name_en":"Gatekeeper of the Void", "art":"res://assets/characters/monsters/m_r4_22.png", "art_key":"m_r4_22", "lore":"镇守归墟最终入口的神圣巨魔，双掌能封死生死界限，拒绝任何未经许可的灵魂涉足。", "lore_en":"The divine custodian of oblivion's final gateway, sealing the threshold between life and death."},
	{"id":"m_r4_23", "realm":4, "tier":3, "element":"void", "tint":"e056fd", "name":"遗世万魂集合体", "name_en":"Congregation of Forgotten Souls", "art":"res://assets/characters/monsters/m_r4_23.png", "art_key":"m_r4_23", "lore":"数百万被遗忘在归墟中的魂魄凝聚成的巨型多面球体，千面千音，威能撼天动地。", "lore_en":"A colossal multi-faced sphere formed from millions of forsaken souls, chanting discordant incantations."},
	{"id":"m_r4_24", "realm":4, "tier":3, "element":"void", "tint":"30336b", "name":"湮灭虚声之王", "name_en":"King of Silent Annihilation", "art":"res://assets/characters/monsters/m_r4_24.png", "art_key":"m_r4_24", "lore":"掌控绝对死寂的虚无王者，在其统御的领域内，一切声音、战技与魔法皆归于沉寂。", "lore_en":"The king of utter silence, stripping all sound, magic, and momentum from the battlefield."},
	{"id":"m_r4_25", "realm":4, "tier":4, "element":"void", "tint":"e67c65", "name":"归墟原初巨神", "name_en":"Primordial Behemoth of Oblivion", "art":"res://assets/characters/monsters/m_r4_25.png", "art_key":"m_r4_25", "lore":"归墟最深处的终极巨神，从不言语，只以冷漠庞大的虚无重力将万事万物碾作虚无。", "lore_en":"The ultimate titan dwelling in the core of oblivion, compressing all existence into quiet nothingness."},

	# =========================================================================
	# REALM 5: 创世烘炉与万象终焉 (Genesis Hearth & Primordial Origin) - Chapters 41 to 50
	# =========================================================================
	# Minions (Tier 1)
	{"id":"m_r5_01", "realm":5, "tier":1, "element":"genesis", "tint":"f368e0", "name":"创世灵火", "name_en":"Genesis Spark", "art":"res://assets/characters/monsters/m_r5_01.png", "art_key":"m_r5_01", "lore":"世界诞生瞬间迸发出的最初火种，跳跃间能自虚无中重新点燃物质形态。", "lore_en":"The very first spark sparked during genesis, dancing to rekindle physical forms from pure vacuum."},
	{"id":"m_r5_02", "realm":5, "tier":1, "element":"genesis", "tint":"ff9f43", "name":"无序星屑", "name_en":"Entropic Stardust", "art":"res://assets/characters/monsters/m_r5_02.png", "art_key":"m_r5_02", "lore":"在星辰尚未成形前漂浮的原初星尘，虽无规则却蕴含磅礴的演化潜能。", "lore_en":"Primordial stardust drifting before galaxies formed, chaotic yet pulsing with creation's vigor."},
	{"id":"m_r5_03", "realm":5, "tier":1, "element":"genesis", "tint":"ee5253", "name":"始源矿核", "name_en":"Primordial Geode", "art":"res://assets/characters/monsters/m_r5_03.png", "art_key":"m_r5_03", "lore":"第一颗星辰冷却凝结的原石晶核，硬度超越世间所有凡俗精金与宝玉。", "lore_en":"The crystallization from the cooling of the first star, harder than any terrestrial alloy or gem."},
	{"id":"m_r5_04", "realm":5, "tier":1, "element":"genesis", "tint":"0abde3", "name":"轮回幼兽", "name_en":"Cycle Cub", "art":"res://assets/characters/monsters/m_r5_04.png", "art_key":"m_r5_04", "lore":"穿梭在因果交接处的灵动异兽，能预判数息之后的命数轨迹以灵活闪避。", "lore_en":"A nimble beast frolicking along causal threads, peering seconds into destiny to dodge blows."},
	{"id":"m_r5_05", "realm":5, "tier":1, "element":"celestial", "tint":"10ac84", "name":"苍天裂片", "name_en":"Firmament Shard", "art":"res://assets/characters/monsters/m_r5_05.png", "art_key":"m_r5_05", "lore":"原初天空初建时崩落的纯净青晶，折射出天地初开时的明澈极光。", "lore_en":"A crystalline flake chipped from the celestial firmament, gleaming with the clear light of genesis."},
	{"id":"m_r5_06", "realm":5, "tier":1, "element":"genesis", "tint":"5f27cd", "name":"时间回响灵", "name_en":"Chrono Echo Wisp", "art":"res://assets/characters/monsters/m_r5_06.png", "art_key":"m_r5_06", "lore":"被困在永恒循环中的时空残波，能在刹那间将受到的创伤回拨倒流。", "lore_en":"A chronological ripple trapped in an infinite loop, fleetingly rewinding recent physical trauma."},
	{"id":"m_r5_07", "realm":5, "tier":1, "element":"genesis", "tint":"c8d6e5", "name":"宿命蛛丝怪", "name_en":"Fate Weaverling", "art":"res://assets/characters/monsters/m_r5_07.png", "art_key":"m_r5_07", "lore":"以万物因果线为丝织网的小妖，触碰其丝线者将感到命运沉重如山。", "lore_en":"A weaver knitting fate's invisible strands, weighting trespassers down with existential gravity."},
	# Elites (Tier 2)
	{"id":"m_r5_08", "realm":5, "tier":2, "element":"genesis", "tint":"ff6b6b", "name":"原始熔炉卫", "name_en":"Genesis Hearth Guardian", "art":"res://assets/characters/monsters/m_r5_08.png", "art_key":"m_r5_08", "lore":"驻守创世神炉旁的火神近卫，挥舞锻造万物的大锤，刚猛不可阻挡。", "lore_en":"The fire titan guarding the cosmic hearth, swinging creation's blacksmith mallet with staggering force."},
	{"id":"m_r5_09", "realm":5, "tier":2, "element":"genesis", "tint":"feca57", "name":"秩序铸造者", "name_en":"Order Smith", "art":"res://assets/characters/monsters/m_r5_09.png", "art_key":"m_r5_09", "lore":"将混沌虚空锤炼定型为现世法则的古老匠神，挥洒秩序金光瓦解破绽。", "lore_en":"An elder smith shaping raw chaos into universal laws, wielding golden runes to seal all gaps."},
	{"id":"m_r5_10", "realm":5, "tier":2, "element":"genesis", "tint":"48dbfb", "name":"创生魔像", "name_en":"Progenitor Golem", "art":"res://assets/characters/monsters/m_r5_10.png", "art_key":"m_r5_10", "lore":"天地初分时诞生的第一具魔像雏形，体内循环着最古老纯正的玄黄母气。", "lore_en":"The primeval golem sculpted when earth first partitioned, circulating foundational primordial chi."},
	{"id":"m_r5_11", "realm":5, "tier":2, "element":"genesis", "tint":"1dd1a1", "name":"永恒回音战魁", "name_en":"Eternal Echo Champion", "art":"res://assets/characters/monsters/m_r5_11.png", "art_key":"m_r5_11", "lore":"在未被时间秩序整理过的回廊中永恒战斗的英灵，其战姿臻至化境。", "lore_en":"An undefeated champion dueling across timeless galleries, whose martial forms are flawless."},
	{"id":"m_r5_12", "realm":5, "tier":2, "element":"celestial", "tint":"54a0ff", "name":"窥世天眼神官", "name_en":"All-Seeing Eye Priest", "art":"res://assets/characters/monsters/m_r5_12.png", "art_key":"m_r5_12", "lore":"侍奉高维巨眼的虔诚神官，能预判一切攻击意图并施加绝对压制。", "lore_en":"A high priest tending the celestial eye, perceiving all intent to enforce divine retribution."},
	{"id":"m_r5_13", "realm":5, "tier":2, "element":"genesis", "tint":"5f27cd", "name":"始末两界执法者", "name_en":"Alpha-Omega Enforcer", "art":"res://assets/characters/monsters/m_r5_13.png", "art_key":"m_r5_13", "lore":"同时立足于宇宙诞生与毁灭两端的执行者，掌中法尺能裁定生命归期。", "lore_en":"An arbiter straddling both the beginning and the end of time, decreeing lifespans with absolute balance."},
	{"id":"m_r5_14", "realm":5, "tier":2, "element":"genesis", "tint":"8395a7", "name":"时间裂境影卫", "name_en":"Timewarp Shadowblade", "art":"res://assets/characters/monsters/m_r5_14.png", "art_key":"m_r5_14", "lore":"来自另一条因果分支的未来战刃，出招先于意动，令寻常感知完全失效。", "lore_en":"A phantom assassin traversing alternate timelines, striking before the blade is even unsheathed."},
	{"id":"m_r5_15", "realm":5, "tier":2, "element":"celestial", "tint":"f368e0", "name":"万魂溯源引导者", "name_en":"Soul Origin Shepherd", "art":"res://assets/characters/monsters/m_r5_15.png", "art_key":"m_r5_15", "lore":"护送所有逝去与待生灵魂归于本源的神圣向导，圣杖所指，万灵臣服。", "lore_en":"A celestial shepherd guiding departing and unborn souls back into genesis, commanding universal respect."},
	# Bosses (Tier 3 & 4)
	{"id":"m_r5_16", "realm":5, "tier":3, "element":"genesis", "tint":"ee5253", "name":"创世初始熔火尊", "name_en":"Genesis Primordial Ignis", "art":"res://assets/characters/monsters/m_r5_16.png", "art_key":"m_r5_16", "lore":"点燃宇宙第一缕光焰的元始炎尊，其炽烈神躯蕴含重造一个世界的浩瀚热能。", "lore_en":"The primordial lord who ignited the first spark of creation, housing the energy to birth galaxies."},
	{"id":"m_r5_17", "realm":5, "tier":3, "element":"genesis", "tint":"5f27cd", "name":"无序混沌主宰", "name_en":"Lord of Primordial Entropy", "art":"res://assets/characters/monsters/m_r5_17.png", "art_key":"m_r5_17", "lore":"诞生于秩序确立之前的无上至尊，能随心所欲扭曲物理因果与五行相克。", "lore_en":"The supreme entity pre-dating all order, effortlessly shifting elemental laws and causality."},
	{"id":"m_r5_18", "realm":5, "tier":3, "element":"celestial", "tint":"feca57", "name":"淬星万神巨炉", "name_en":"Celestial Star-Forge Titan", "art":"res://assets/characters/monsters/m_r5_18.png", "art_key":"m_r5_18", "lore":"锻造所有璀璨星辰的万神熔炉本体，炉膛喷涌出的星火能熔断天地万法。", "lore_en":"The primeval forge that cast all stars into being, venting flames that disintegrate martial arts and magic."},
	{"id":"m_r5_19", "realm":5, "tier":3, "element":"genesis", "tint":"54a0ff", "name":"永恒时间裁决神", "name_en":"Chrono Judgment God", "art":"res://assets/characters/monsters/m_r5_19.png", "art_key":"m_r5_19", "lore":"坐镇时间长河尽头的至高裁决者，弹指之间便能让凡人岁月流逝百年。", "lore_en":"The supreme magistrate enthroned at time's delta, advancing mortals' lifespans by centuries in a blink."},
	{"id":"m_r5_20", "realm":5, "tier":3, "element":"celestial", "tint":"ff6b6b", "name":"诸界全知巨瞳", "name_en":"Omniscient World Eye", "art":"res://assets/characters/monsters/m_r5_20.png", "art_key":"m_r5_20", "lore":"俯瞰所有平行世界的终极神瞳，它每一次眨眼的微秒，便是一个大千世界的终结。", "lore_en":"The all-seeing eye overlooking all alternate dimensions, whose single blink heralds a universe's twilight."},
	{"id":"m_r5_21", "realm":5, "tier":3, "element":"genesis", "tint":"1dd1a1", "name":"始末归一大神官", "name_en":"Hierophant of Beginning and End", "art":"res://assets/characters/monsters/m_r5_21.png", "art_key":"m_r5_21", "lore":"掌管起点与终点在此重合之地的神圣大祭司，举手投足皆合乎天道运转。", "lore_en":"The arch-hierophant where beginning and ending merge into one, moving in total harmony with the cosmos."},
	{"id":"m_r5_22", "realm":5, "tier":3, "element":"genesis", "tint":"0abde3", "name":"时空错位悖论神", "name_en":"Paradox Temporal Entity", "art":"res://assets/characters/monsters/m_r5_22.png", "art_key":"m_r5_22", "lore":"由无数冲突的时间线撕扯融合诞生的悖论神灵，存在本身即是对因果律的嘲讽。", "lore_en":"A paradox entity born from colliding timelines, whose existence refutes the laws of cause and effect."},
	{"id":"m_r5_23", "realm":5, "tier":3, "element":"genesis", "tint":"10ac84", "name":"万魂归源母树", "name_en":"Mother Tree of All Souls", "art":"res://assets/characters/monsters/m_r5_23.png", "art_key":"m_r5_23", "lore":"扎根于虚无始源的生命之母，所有曾存在与将存在的灵魂皆为其舒展的枝叶。", "lore_en":"The sacred mother tree rooted at genesis, holding every soul that ever was or will be in its boughs."},
	{"id":"m_r5_24", "realm":5, "tier":3, "element":"genesis", "tint":"c8d6e5", "name":"创世最初回声尊", "name_en":"The First Echo of Creation", "art":"res://assets/characters/monsters/m_r5_24.png", "art_key":"m_r5_24", "lore":"天地诞生的第一声浩荡回响凝结出的古神，其声音蕴含唤醒与湮灭万象的神威。", "lore_en":"The deity materialized from creation's very first resonance, awakening or undoing reality at will."},
	{"id":"m_r5_25", "realm":5, "tier":4, "element":"genesis", "tint":"e67c65", "name":"万象始源·天道真灵", "name_en":"The Primordial Origin: Spirit of the Cosmos", "art":"res://assets/characters/monsters/m_r5_25.png", "art_key":"m_r5_25", "lore":"万象的终焉，也是万象的起点——全知全能的天道意志本体，守护着世界最初与最终的秘密。", "lore_en":"The end and origin of all things — the supreme cosmic consciousness guarding the ultimate mystery of existence."}
]
...
func _get_encounter_enemy(chapter: int, level: int) -> Dictionary:
	var realm: int = clampi((chapter - 1) / 10 + 1, 1, 5)
	var ch_in_realm: int = (chapter - 1) % 10
	var realm_start: int = (realm - 1) * 25
	if level == 5:
		if ch_in_realm == 9:
			return MONSTER_ROSTER[realm_start + 24]
		else:
			return MONSTER_ROSTER[realm_start + 15 + ch_in_realm]
	elif level == 3:
		return MONSTER_ROSTER[realm_start + 7 + (ch_in_realm % 8)]
	elif level == 4:
		return MONSTER_ROSTER[realm_start + 7 + ((ch_in_realm + 4) % 8)]
	elif level == 1:
		return MONSTER_ROSTER[realm_start + (ch_in_realm % 7)]
	else:
		return MONSTER_ROSTER[realm_start + ((ch_in_realm + 3) % 7)]
