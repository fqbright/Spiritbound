...
const UI_TEXT = {
	...
	"ui.replay_modal_title": {"zh-Hans":"已通关关卡 · 挑战选择", "en":"Cleared Stage · Challenge Select"},
	"ui.replay_normal_title": {"zh-Hans":"常规重温", "en":"Standard Replay"},
	"ui.replay_normal_desc": {"zh-Hans":"金币收益减半，不再掉落卡牌、装备与符文。", "en":"Half gold, no card, equipment or rune drops."},
	"ui.replay_hard_title": {"zh-Hans":"强化试炼重温", "en":"Trial Replay (Hard)"},
	"ui.replay_hard_desc": {"zh-Hans":"敌人附加随机强化词条，恢复全额金币收益与掉落！", "en":"Enemies gain affixes; restores 100% gold & item drops!"},
	"ui.replay_hard_badge": {"zh-Hans":"⚡ 试炼重温", "en":"⚡ Trial Replay"},
