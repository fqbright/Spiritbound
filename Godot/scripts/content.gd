...
const UI_TEXT = {
	...
	"ui.drag_to_cast": {"zh-Hans":"按住卡牌拖向敌方释放", "en":"Drag card to target enemy"},
	"ui.stamina_full_time": {"zh-Hans":"全部回满还需: %s", "en":"Full in: %s"},
	"ui.boss_intro_prefix": {"zh-Hans":"✦ 第 %d 章 · 守境领主 ✦", "en":"✦ Chapter %d · Domain Lord ✦"},
	"ui.boss_intro_boss": {"zh-Hans":"首领降临", "en":"Boss Encounter"},
	"ui.boss_intro_elite": {"zh-Hans":"精英妖兽", "en":"Elite Nemesis"},
	"ui.avg_cost": {"zh-Hans":"均费", "en":"Avg Cost"},
	"ui.intent_calc_dmg": {"zh-Hans":"✦ 基础伤害: %d", "en":"✦ Raw Damage: %d"},
	"ui.intent_calc_shield_absorb": {"zh-Hans":"🛡 护盾吸收: %d", "en":"🛡 Shield Absorb: %d"},
	"ui.intent_calc_hp_loss": {"zh-Hans":"♥ 实际损失: %d 生命", "en":"♥ Real Loss: %d HP"},
	"ui.intent_calc_lethal": {"zh-Hans":"致死重创预警！", "en":"Lethal Threat Warning!"},
	"ui.intent_calc_shield_gain": {"zh-Hans":"🛡 聚气聚元: 获得 +%d 护盾", "en":"🛡 Channeling: Gain +%d Shield"},
	"ui.intent_calc_buff": {"zh-Hans":"⚡ 强体运气: 威能提升 +%d", "en":"⚡ Empowering: Gain +%d Power"},
	"ui.intent_calc_curse": {"zh-Hans":"☠ 施咒散煞: 附加 %d 层异况", "en":"☠ Curse: Inflict %d Debuff"},
	"ui.celestial_dawn": {"zh-Hans":"🌅 晨曦拂晓", "en":"🌅 Golden Dawn"},
	"ui.celestial_noon": {"zh-Hans":"☀️ 骄阳正午", "en":"☀️ Radiant Noon"},
	"ui.celestial_dusk": {"zh-Hans":"🌄 暮霞晚照", "en":"🌄 Crimson Dusk"},
	"ui.celestial_midnight": {"zh-Hans":"🌌 子夜星汉", "en":"🌌 Midnight Starlight"},
	"ui.end_turn_leak": {"zh-Hans":"⚠ 预计承受 %d 伤", "en":"⚠ Incurring %d Dmg"},
	"ui.end_turn_lethal": {"zh-Hans":"⚠ 敌意致死！", "en":"⚠ Lethal Threat!"},
	"ui.lethal_execute": {"zh-Hans":"斩", "en":"KILL"},
	"ui.card_synergy_badge": {"zh-Hans":"✦ 流派契合", "en":"✦ Synergy"},
	"ui.combo_count_fmt": {"zh-Hans":"⚡ %d 连击！", "en":"⚡ %d HITS!"},
	"ui.chronicles_title": {"zh-Hans":"修真历练古卷", "en":"Chronicles of Past Journeys"},
	"ui.chronicles_empty": {"zh-Hans":"暂无历练记录，启程踏入修真征程吧！", "en":"No past journeys recorded yet."},
	"ui.chronicles_run_fmt": {"zh-Hans":"第 %d 回合 · %s · 第 %s 关", "en":"Turn %d · %s · Stage %s"},
	"ui.chronicles_btn": {"zh-Hans":"📜 历练古卷", "en":"📜 Chronicles"},
	"ui.chronicles_vic": {"zh-Hans":"凯旋", "en":"Victory"},
	"ui.chronicles_def": {"zh-Hans":"兵解", "en":"Defeat"},
	"ui.draw_forecast_fmt": {"zh-Hans":"📊 预测: ⚔️%d%% | 🛡️%d%% | ⚡%d%%", "en":"📊 Forecast: ⚔️%d%% | 🛡️%d%% | ⚡%d%%"},
	"ui.chronicles_copied": {"zh-Hans":"📜 战报已复制至剪贴板！", "en":"📜 Battle report copied to clipboard!"},
	"ui.chronicles_share": {"zh-Hans":"复制战报", "en":"Copy Report"},
	"ui.shop_restock_btn": {"zh-Hans":"🔄 换一批", "en":"🔄 Restock"},
	"ui.shop_restock_toast": {"zh-Hans":"奇宝阁已换新！", "en":"Merchant stock refreshed!"},
	"ui.shop_bargain_badge": {"zh-Hans":"🏷️ 特惠 -30%", "en":"🏷️ -30% Deal"},
	"ui.upgrade_preview_title": {"zh-Hans":"觉醒分支对比", "en":"Awakening Branch Diff"},
	"ui.upgrade_current_form": {"zh-Hans":"当前形态", "en":"Current"},
	"ui.upgrade_flow_form": {"zh-Hans":"顺流分支", "en":"Flow Branch"},
	"ui.upgrade_surge_form": {"zh-Hans":"狂涌分支", "en":"Surge Branch"},
	"ui.preset_rename_title": {"zh-Hans":"修改卡组预设名称", "en":"Rename Deck Preset"},
	"ui.preset_rename_prompt": {"zh-Hans":"请输入新的卡组预设称号：", "en":"Enter new deck preset name:"},
	"ui.preset_renamed_toast": {"zh-Hans":"卡组预设已重命名为：%s", "en":"Deck preset renamed to: %s"},
	"status.shield.name": {"zh-Hans":"护盾", "en":"Shield"},
	"status.shield.desc": {"zh-Hans":"抵消受到的攻击伤害，回合结束时不保留（壁垒状态除外）。", "en":"Absorbs incoming attack damage. Clears at turn end unless Bastion is active."},
	"status.burn.name": {"zh-Hans":"灼烧", "en":"Burn"},
	"status.burn.desc": {"zh-Hans":"每回合开始受到等同层数的火焰伤害，随后层数减半。", "en":"Takes fire damage equal to stacks at turn start, then stacks halve."},
	"status.poison.name": {"zh-Hans":"中毒", "en":"Poison"},
	"status.poison.desc": {"zh-Hans":"每回合开始受到等同层数的穿透伤害（穿透护盾），随后层数减 1。", "en":"Takes piercing damage equal to stacks at turn start, then stacks reduce by 1."},
	"status.stun.name": {"zh-Hans":"眩晕", "en":"Stun"},
	"status.stun.desc": {"zh-Hans":"无法行动，跳过下一个行动回合。", "en":"Stunned. Skips next turn."},
	"status.vulnerable.name": {"zh-Hans":"易伤", "en":"Vulnerable"},
	"status.vulnerable.desc": {"zh-Hans":"受到的攻击伤害增加 50%。", "en":"Takes 50% more attack damage."},
	"status.weak.name": {"zh-Hans":"虚弱", "en":"Weak"},
	"status.weak.desc": {"zh-Hans":"造成的攻击伤害减少 25%。", "en":"Deals 25% less attack damage."},
	"status.strength.name": {"zh-Hans":"力量", "en":"Strength"},
	"status.strength.desc": {"zh-Hans":"所有攻击牌造成的伤害增加对应点数。", "en":"Increases attack damage by the stack amount."},
	"status.focus.name": {"zh-Hans":"蓄力", "en":"Focus"},
	"status.focus.desc": {"zh-Hans":"下一次攻击造成的伤害大幅提升。", "en":"Next attack deals significantly increased damage."},
	"ui.battle_telemetry": {"zh-Hans":"战斗统计", "en":"Combat Report"},
	"ui.telemetry_turns": {"zh-Hans":"回合: %d", "en":"Turns: %d"},
	"ui.telemetry_damage": {"zh-Hans":"造成伤害: %d", "en":"Dmg: %d"},
	"ui.telemetry_shield": {"zh-Hans":"承受格挡: %d", "en":"Shielded: %d"},
	"ui.mvp_card": {"zh-Hans":"本场 MVP 卡牌", "en":"MVP Card"},
	"ui.shield_break": {"zh-Hans":"护盾击破!", "en":"SHIELD BROKEN!"},
	"ui.quick_sweep": {"zh-Hans":"快速扫荡", "en":"Quick Sweep"},
	"ui.sweep_cost": {"zh-Hans":"消耗 5 体力", "en":"Cost: 5 Stamina"},
	"ui.sweep_stage_title": {"zh-Hans":"第 %d 关 · 扫荡成功", "en":"Stage %d Cleared"},
	"ui.sweep_confirm": {"zh-Hans":"已通关关卡，是否消耗 5 体力立即扫荡获取通关收益？", "en":"Stage already cleared. Spend 5 stamina to sweep immediately?"},
	"ui.claim_achievement": {"zh-Hans":"领取", "en":"Claim"},
	"ui.claim_all_achievements": {"zh-Hans":"一键领取全部", "en":"Claim All"},
	"ui.achievement_claimed_toast": {"zh-Hans":"✦ 获得 %d 灵玉！", "en":"✦ Claimed %d Spirit Jade!"},
	"push.stamina.title": {"zh-Hans":"宗门灵气充盈", "en":"Stamina Full"},
	"push.stamina.body": {"zh-Hans":"体力已完全恢复满（120/120），快回山门继续历练！", "en":"Stamina fully recharged (120/120). Return to continue your journey!"},
	"push.harvest.title": {"zh-Hans":"巡航挂机满载", "en":"Harvest Capacity Reached"},
	"push.harvest.body": {"zh-Hans":"挂机收益已累积至上限，快来收获丰厚灵石宝藏！", "en":"Offline exploration full! Claim your spirit rewards now."},
	...
	"ui.settings_haptics": {"zh-Hans":"触感震动反馈", "en":"Haptic Vibration"},
	...
	"ui.deck_type_attack": {"zh-Hans":"攻击", "en":"Attack"},
	"ui.deck_type_skill": {"zh-Hans":"技能", "en":"Skill"},
	"ui.deck_type_power": {"zh-Hans":"能力", "en":"Power"},
	"ui.win_streak_badge": {"zh-Hans":"%d 连胜！", "en":"%d-Win Streak!"},
	"ui.win_streak_bonus": {"zh-Hans":"连胜加成", "en":"Streak Bonus"},
	"ui.offline_welcome_title": {"zh-Hans":"仙府静修收获", "en":"Offline Cultivation Rewards"},
	"ui.offline_welcome_desc": {"zh-Hans":"道友离线静修已有 %d 小时，灵田药园与灵脉源泉已凝聚丰厚机缘！", "en":"You have cultivated offline for %d hours, gathering rich spirit harvest!"},
	"ui.reward_skip_dust": {"zh-Hans":"放弃并熔炼 (+%d 灵尘)", "en":"Skip & Smelt (+%d Dust)"},
	"ui.reward_skip_dust_toast": {"zh-Hans":"化解卡牌机缘，获得 %d 灵尘！", "en":"Smelted card reward for %d Spirit Dust!"},
	"ui.card_combo_badge": {"zh-Hans":"✦ 连携 ✦", "en":"✦ COMBO ✦"},
	"ui.deck_share_btn": {"zh-Hans":"分享牌组", "en":"Share Deck"},
	"ui.deck_import_btn": {"zh-Hans":"导入牌组", "en":"Import Deck"},
	"ui.deck_copied_toast": {"zh-Hans":"牌组代码已复制到剪贴板！", "en":"Deck code copied to clipboard!"},
	"ui.deck_imported_toast": {"zh-Hans":"成功导入牌组代码！", "en":"Deck imported successfully!"},
	"ui.deck_invalid_toast": {"zh-Hans":"无效的牌组代码！", "en":"Invalid deck code!"},
	"ui.deck_import_title": {"zh-Hans":"导入牌组代码", "en":"Import Deck Code"},
	"ui.deck_import_placeholder": {"zh-Hans":"在此粘贴 SPRT: 开头的牌组代码...", "en":"Paste SPRT: deck code here..."},
	"ui.map_intel_preview": {"zh-Hans":"前方敌情侦测", "en":"Ahead Reconnaissance"},
	"ui.map_intel_locked": {"zh-Hans":"该关卡尚未解锁，请先攻克前方关隘", "en":"Stage locked. Conquer preceding paths first."},
	"ui.map_intel_recommended": {"zh-Hans":"推荐克制", "en":"Recommended Counter"},
	"ui.combat_speed": {"zh-Hans":"%s倍速", "en":"%sx Speed"},
	"ui.combat_undo": {"zh-Hans":"↺ 溯流", "en":"↺ Undo"},
	"ui.cast_ultimate": {"zh-Hans":"⚡神通", "en":"⚡Ult"},
	"ui.combat_undo_toast": {"zh-Hans":"时间溯流，撤销出牌！", "en":"Chrono rewind: move undone!"},
	"ui.combat_blocked": {"zh-Hans":"✦ 格挡 ✦", "en":"✦ BLOCKED ✦"},
	...
	"ui.epiphany_boon_shield": {"zh-Hans":"磐石凝神 (+14 护盾)", "en":"Bastion Focus (+14 Shield)"},
	"ui.epiphany_boon_energy": {"zh-Hans":"灵脉涌流 (+2 能量)", "en":"Leyline Surge (+2 Energy)"},
	"ui.epiphany_boon_drain": {"zh-Hans":"嗜血杀伐 (下张攻击吸血)", "en":"Blood Pact (Next Attack Lifesteals)"},
	"ui.epiphany_toast": {"zh-Hans":"神识顿悟觉醒！机缘加身！", "en":"Divine Epiphany awakened!"},
	"ui.sanctuary_garden_title": {"zh-Hans":"仙府灵草园", "en":"Sanctuary Garden"},
	"ui.sanctuary_harvest_btn": {"zh-Hans":"采摘灵草 (+%d 灵尘)", "en":"Harvest Herbs (+%d Dust)"},
	"ui.sanctuary_pet_btn": {"zh-Hans":"抚慰灵宠", "en":"Pet Familiar"},
	"ui.sanctuary_pet_toast": {"zh-Hans":"灵狐欢快地摇着尾巴，散发温润灵气~", "en":"The spirit fox happily sways its tails!"},
	"ui.sanctuary_harvest_toast": {"zh-Hans":"采撷仙草灵韵，获得 %d 灵尘！", "en":"Harvested celestial herbs for %d Spirit Dust!"},
	"ui.victory_card_btn": {"zh-Hans":"道印战报 📜", "en":"Victory Card 📜"},
	"ui.victory_card_title": {"zh-Hans":"封神试炼 · 道印画卷", "en":"Spirit Trial · Victory Scroll"},
	"ui.victory_card_copied": {"zh-Hans":"道印战报文本已复制，可分享至同道！", "en":"Victory recap copied to clipboard!"},
	"ui.title_label": {"zh-Hans":"修仙尊号", "en":"Prestige Title"},
	"ui.title_frost": {"zh-Hans":"踏雪寻仙", "en":"Frost Pathfinder"},
	"ui.title_flame": {"zh-Hans":"踏火焚天", "en":"Flame Dominator"},
	"ui.title_thunder": {"zh-Hans":"九天劫雷尊", "en":"Thunder Sovereign"},
	"ui.title_abyss": {"zh-Hans":"深渊征服者", "en":"Abyss Conqueror"},
	"ui.title_master": {"zh-Hans":"万法归一至尊", "en":"Grandmaster Sovereign"},
